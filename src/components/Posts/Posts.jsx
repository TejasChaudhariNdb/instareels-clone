                                    ...
                                    <Grid item xs={12} sm={12} md={12} lg={12} key={post.postDocID}>
                                        <Card variant="outlined" className={classes.postCard}>
                                            ...
                                            <CardMedia className={classes.reels}>
                                                <div className='videos' style={{ position: "relative"}} ><Video source={post?.postURL} id={post?.postID} />
                                                
                                                
                                                <div  style={{ height: "1.5rem" }} className={classes.actionbutton}>
                                                {post.likes.length !== 0 ? post.likes.length === 1 ? <p className={classes.likeStat}>1 </p> : <p className={classes.likeStat}>{post.likes.length}</p> : <></>}
